...
export function ConversationList({
  ...
  return (
    <section className="flex w-full min-w-0 shrink-0 flex-col border-r border-border/80 bg-card/75 shadow-[1px_0_0_rgba(255,255,255,0.03)_inset] backdrop-blur-xl md:w-[372px] xl:w-[420px]">
