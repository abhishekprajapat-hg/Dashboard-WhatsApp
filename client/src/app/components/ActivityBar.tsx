...
const NAV_ITEMS: { id: ViewId; icon: LucideIcon; label: string }[] = [
  ...
  { id: "leads", icon: Target, label: "Pipeline" },
...
const navButtonState = {
  active: "bg-primary/12 text-primary shadow-[0_0_0_1px_rgba(11,116,128,0.24)_inset,0_12px_30px_rgba(11,116,128,0.08)]",
        ...
        <TooltipTrigger asChild>
          ...
          >
            ...
            {item.id === "inbox" && unreadCount > 0 && (
              <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full border border-sidebar bg-primary px-1 text-[9px] font-bold leading-4 text-primary-foreground shadow-[0_0_18px_rgba(11,116,128,0.45)]">
                {unreadLabel}
              </span>
            )}
    ...
    <TooltipProvider delayDuration={250}>
      <aside className="relative z-40 hidden h-dvh w-[72px] shrink-0 flex-col border-r border-sidebar-border bg-sidebar/95 px-3 py-4 text-sidebar-foreground backdrop-blur-xl md:flex">
        <div className="hidden md:flex md:flex-col md:items-center md:gap-2">
          <div className="relative flex size-10 items-center justify-center rounded-xl border border-primary/25 bg-primary text-primary-foreground shadow-[0_16px_36px_rgba(11,116,128,0.18)]">
