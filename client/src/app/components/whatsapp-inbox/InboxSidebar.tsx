  ...
  return (
    <aside className="hidden w-[76px] shrink-0 flex-col border-r border-border/80 bg-sidebar/95 text-muted-foreground shadow-[1px_0_0_rgba(255,255,255,0.03)_inset] lg:flex">
      <div className="flex h-[76px] items-center justify-center border-b border-border/80">
        <div className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-primary text-sm font-semibold text-primary-foreground shadow-[0_16px_38px_rgba(11,116,128,0.16)]">
          WA
          ...
          return (
            <button
              ...
              className={cn(
                ...
                activeFilter === item.id && "bg-primary/12 text-primary shadow-[0_0_0_1px_rgba(11,116,128,0.22)_inset]"
              )}
